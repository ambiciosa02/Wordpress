...
if ( ! class_exists( 'Interior_Decor_Consultation_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Interior_Decor_Consultation_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Interior_Decor_Consultation_WPTT_WebFont_Loader( $url );
