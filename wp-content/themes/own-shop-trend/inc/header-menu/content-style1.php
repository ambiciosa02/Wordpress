...
<header id="<?php echo esc_attr($page_val); ?>-inner" class="elementor-menu-anchor theme-menu-wrapper full-width-menu style1 own-store-header page" role="banner">
	<a class="skip-link screen-reader-text" href="#main"><?php esc_html_e( 'Skip to content', 'own-shop-trend' ); ?></a>
	<?php
		...
		<div class="<?php echo esc_attr(OWN_SHOP_CONTAINER_CLASS) ?>">
			...
			<div class="logo">
                ...
                <?php 
                	...
                	if(!empty($alt_logo)) :
	                	?>
	                		<a id="logo-alt" class="logo-alt" href="<?php echo esc_url(home_url( '/' )); ?>"><img src="<?php echo esc_url( get_theme_mod( 'own_shop_sticky_logo' ) ); ?>" alt="<?php esc_attr__( 'logo', 'own-shop-trend' ) ?>"></a>
	                	<?php
	                endif;
	            ?>
	            <?php
			...
			<div class="responsive-nav hidden-lg hidden-md hidden-sm">
				<div class="top-menu-wrapper">
					<nav class="top-menu" role="navigation" aria-label="<?php esc_attr_e( 'primary', 'own-shop-trend' ); ?>">
						<div class="menu-header">
							<?php 
							 ...
							 ?>
							<span><?php esc_html_e('MENU','own-shop-trend'); ?> </span>
					     	<button type="button" class="hd-bar-opener navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-1" aria-expanded="false">
						       	<span class="sr-only"><?php esc_html_e( 'Toggle navigation', 'own-shop-trend' ); ?></span>
