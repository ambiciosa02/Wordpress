...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $supermarket_shopping_archive_sidebar_setting = get_theme_mod('supermarket_shopping_archive_sidebar_setting','1');
	            $supermarket_shopping_sidebar_position = get_theme_mod('supermarket_shopping_sidebar_position', 'right');
	            $supermarket_shopping_content_class = ($supermarket_shopping_archive_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $supermarket_shopping_archive_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
