( function( $ ) {
  var this_obj = supermarket_shopping_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'supermarket_shopping_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'supermarket_shopping_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'supermarket_shopping_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'supermarket_shopping_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.supermarket-shopping-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.supermarket-shopping-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'supermarket-shopping-tab': api.Tab
  });
