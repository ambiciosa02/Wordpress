...
jQuery(document).ready(function(){
    ...
    jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-menu').attr("checked","checked");

    jQuery('#supermarket-shopping-setup-menu').click(function(){
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-menu').css("display","block");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-contact').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-widget').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-social-icon').css("display","none");
    });

    jQuery('#supermarket-shopping-setup-contact').click(function(){
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-menu').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-contact').css("display","block");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-widget').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-social-icon').css("display","none");
    });

    jQuery('#supermarket-shopping-setup-widget').click(function(){
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-menu').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-contact').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-widget').css("display","block");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-social-icon').css("display","none");
    });

    jQuery('#supermarket-shopping-setup-social').click(function(){
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-menu').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-contact').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-widget').css("display","none");
        jQuery('#supermarket-shopping-demo-setup-guid .supermarket-shopping-setup-social-icon').css("display","block");
    });
});