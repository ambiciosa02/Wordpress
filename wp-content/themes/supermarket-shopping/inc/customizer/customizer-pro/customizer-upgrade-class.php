...
if ( class_exists( 'WP_Customize_Control' ) ) :
     ...
     * @since 1.0.0
     */
	class Supermarket_Shopping_Control_Upgrade extends WP_Customize_Control {
        ...
        protected function content_template() {
            ?>
                <div class="mt-upgrade-pro-wrapper">
                    ...
                    <# } #>
                    <a class="mt-upgrade-btn" href="<?php echo esc_url( SUPERMARKET_SHOPPING_PRO_THEME_URL ); ?>" target="_blank"><?php esc_html_e( 'upgrade to pro', 'supermarket-shopping' ); ?></a>
                    <a class="mt-upgrade-btn-bundle" href="<?php echo esc_url( SUPERMARKET_SHOPPING_THEME_BUNDLE_URL ); ?>" target="_blank"><?php esc_html_e( 'Buy All Themes', 'supermarket-shopping' ); ?></a>
