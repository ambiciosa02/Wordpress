...
if ( ! class_exists( 'Supermarket_Shopping_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Supermarket_Shopping_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Supermarket_Shopping_WPTT_WebFont_Loader( $url );
